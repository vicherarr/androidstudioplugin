...
`build/distributions/AndroidStudioTemplate-1.0.4.zip`

> 📦 En `dist/AndroidStudioTemplate-1.0.4.zip` hay una copia ya compilada, lista para
...
4. Selecciona el archivo Zip (`dist/AndroidStudioTemplate-1.0.4.zip`, o el que hayas
